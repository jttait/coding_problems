...
class PartTwoTest {
    ...
    void shouldBe1for0after1blink() {
        ...
        long result = partTwo.stoneAfterBlinks(stones, 1);
    ...
    void shouldBe22for125and17after6blinks() {
        ...
        long result = partTwo.stoneAfterBlinks(stones, 6);
    ...
    void shouldBe186175forAdventOfCodeInputAfter25blinks() {
        ...
        long result = partTwo.stoneAfterBlinks(stones, 25);
        Assertions.assertEquals(186175L, result);
    }

    @Test
    void shouldBe220566831337810forAdventOfCodeInputAfter75blinks() {
        List<Long> stones = List.of(5688L, 62084L, 2L, 3248809L, 179L, 79L, 0L, 172169L);
        long result = partTwo.stoneAfterBlinks(stones, 75);
        Assertions.assertEquals(220566831337810L, result);
    }
}