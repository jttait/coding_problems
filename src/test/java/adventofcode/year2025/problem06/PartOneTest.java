...
class PartOneTest {
    ...
    void shouldBe4277556forAdventOfCodeExample() throws Exception {
        List<Problem> problems = fileLoader.loadProblemsFromFile("adventofcode/year2025/problem06_example.txt");
        long result = 0;
    ...
    void shouldBe4412382293768forAdventOfCodeInput() throws Exception {
        List<Problem> problems = fileLoader.loadProblemsFromFile("adventofcode/year2025/problem06_input.txt");
        long result = 0;
        for (Problem problem : problems) {
            result += partOne.calculate(problem);
        }
