...
class PartTwoTest {
    ...
    void shouldBe43forAdventOfCodeExample() throws Exception {
        List<List<Character>> grid = testUtils.loadFromFile("adventofcode/year2025/problem04_example.txt");
        PartTwo partTwo = new PartTwo(grid);
        int result = partTwo.countRemovableRolls();
    ...
    void shouldBe8184forAdventOfCodeInput() throws Exception {
        List<List<Character>> grid = testUtils.loadFromFile("adventofcode/year2025/problem04_input.txt");
        PartTwo partTwo = new PartTwo(grid);
        int result = partTwo.countRemovableRolls();
