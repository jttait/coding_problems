package adventofcode2025.problem05;
...
class PartOneTest {
    ...
    void shouldBe3forAdventOfCodeExample() throws Exception {
        IngredientsDatabase ingredientsDatabase = testUtils.loadFromFile("problem05_example.txt");
        long result = ingredientsDatabase.countFreshIngredients();
    ...
    void shouldBe3forAdventOfCodeInput() throws Exception {
        IngredientsDatabase ingredientsDatabase = testUtils.loadFromFile("problem05_input.txt");
        long result = ingredientsDatabase.countFreshIngredients();
